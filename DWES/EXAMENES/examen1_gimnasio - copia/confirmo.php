...
?>
    ...
    <nav>
        ...
        foreach ($clases_gimnasio[$nombre_clase] as $clase) {
                    ...
                    echo "<a href='procesar_formulario.php?nombre_clase=$nombre_clase&dia_clase=$dia_clase&hora_clase=".$clase['hora']."'>¿Confirma la reserva para la clase de $nombre_clase  el $dia_clase a las ".$clase['hora']."</a><br/><br/>";
